...
The activities are labeled by reading the activity names from the activity_labels.txt file. The activity column is changed to a factor using the activity labels: walking, upstairs, downstairs, sitting, standing and laying.
...
(http://archive.ics.uci.edu/ml/datasets/Human+Activity+Recognition+Using+Smartphones#)_
...
_The following documentation copied from README.txt_
...
_The following documentation copied from features_info.txt_
...
The field names of the tidy data. Mean and std fields defined above.

(unlaberled) - the data row number
